<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttendancePresenceCode.aspx.cs" Inherits="OnlineHRS.ModalWindowPages.AttendancePresenceCode" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Window ID="PresenceCodeWindow" runat="server" Height="700" Width="900" AutoScroll="true" Maximizable="false" Icon="CalendarViewDay" Title="کد حضور"
            Layout="FitLayout" CloseAction="Destroy" RTL="true" IDMode="Static">
            <LayoutConfig>
                <ext:FitLayoutConfig ItemCls="width-full" />
            </LayoutConfig>
            <Items>
                <ext:FormPanel ID="formPresenceCode" runat="server" Frame="true" Header="false" AutoHeight="true" Layout="TableLayout" AutoScroll="true">
                    <LayoutConfig>
                    ...
                    <Items>
                        ...
                        <ext:FieldSet
                            ...
                            Flex="1"
                            Title=""
                            Layout="TableLayout" Collapsible="true" ColSpan="2">
                            ...
                            <Items>
                                ...
                                <ext:ComboBox runat="server" ID="Codes_WorkType" FieldLabel="نوع حضور" LabelAlign="Right" LabelWidth="70" Margin="8" Editable="false">
                                    <Items>
                        ...
                        <ext:FieldSet
                            ...
                            <Items>
                                ...
                                <ext:TextField runat="server" ID="Codes_FloatTime" FieldLabel="شناوری" />
                        ...
                        <ext:FieldSet
                            ...
                            <Items>
                                ...
                                <ext:Checkbox runat="server" ID="Codes_IsLicNightWork" BoxLabel="شبکاری نیاز به مجوز دارد؟" LabelAlign="Right" LabelWidth="150" ColSpan="2" Width="200" BoxLabelAlign="After" />
                            </Items>
                        </ext:FieldSet>
                        <ext:FieldSet
                            runat="server"
                            ...
                            <Items>
                                ...
                                <ext:Checkbox runat="server" ID="Codes_EnterFlexibleDeduction" BoxLabel="ارفاق در ورود مشمول کسرکار نباشد" LabelAlign="Right" LabelWidth="200" ColSpan="2" Width="250" BoxLabelAlign="After" />
                            </Items>
                        </ext:FieldSet>
