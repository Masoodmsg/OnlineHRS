...
Ext.util.Filter.override({
    serialize: function() {
        ...
        if ((this.type === "date") && this.submitFormat) {
            result.value = Ext.Date.format(new Date(result.value), this.submitFormat);
        }
        delete result.id;
        return result;
    }
...
Ext.dom.Element.override({
    ...
    is: function(selector) {
        ...
        if (!selector) {
            ...
            is = selector(dom);
        } else if (dom[Ext.supports.matchesSelector]) {
            is = dom[Ext.supports.matchesSelector](selector);
        } else if (document.documentElement[Ext.supports.matchesSelector]) {
...
Ext.define('Ext.override.dom.Element', {
    ...
    wrap: function(config, returnDom, selector) {
        var me = this,
            ...
            target = newEl,
            activeElement = Ext.get(Ext.Element.getActiveElement()),
            resumeFocus;
        if (selector) {
    ...
    beforerequest: {
        fn: function(conn, options) {
                ...
                case "public":
                    ...
                    if (o.before) {
                        if (o.before.call(o.scope || o.control || window, o.control, o.eventType, o.action, o.extraParams, o) === false) {
                            if (o.control && o.control.onDirectEventCancel) {
                    ...
                    if (o.cleanRequest) {
                        ...
                        if (o.json) {
                            ...
                            var ov, encode = Ext.isBoolean(o.encode) ? o.encode : Ext.net.DirectEvent.encode;
                            if (encode) {
                                for (key in o.params) {
                                    ov = o.params[key];
                                    if (typeof ov == "object") {
            ...
            var el, em = o.eventMask || {},
                ...
                showDurationMessages = Ext.net.DirectEvent.forbidDurationMessages !== true && durationMessages && durationMessages.length > 0 && ((em.showDurationMessages === true) || (Ext.net.DirectEvent.showDurationMessages && !Ext.isDefined(em.showDurationMessages)));
...
Ext.apply(Ext.net.DirectEvent, {
    ...
    requestFailureHandler: function(response, options) {
        ...
        if (o.userFailure) {
            o.userFailure.call(o.userScope || o.control || window, response, {
        ...
        if (o.userComplete) {
            o.userComplete.call(o.userScope || o.control || window, false, response, {
                "errorMessage": response.statusText
            }, o.control, o.eventType, o.action, o.extraParams, o);
        }
    },
...
Ext.define('Ext.net.Viewport', {
    ...
    requires: ['Ext.net.plugin.Viewport'],
...
Ext.net.FieldNote = {
    ...
    beforeSubTpl: ['<tpl if="noteAlign==\'top\'">', '<div id="{id}-note" class="x-field-note {noteCls}">{noteHtml}</div>', '</tpl>', ],
    afterSubTpl: ['<tpl if="noteAlign==\'down\'">', '<div id="{id}-note" class="x-field-note {noteCls}">{noteHtml}</div>', '</tpl>', ],
    indicatorTpl: ['<div id="{id}-indicator" style="position:relative;display:table-cell;">', '<div class="x-field-indicator {indicatorCls} {indicatorIconCls}">{indicatorHtml}</div>', '</div>'],
    hideNote: function() {
...
Ext.override(Ext.form.field.Text, {
    ...
    onFocus: function() {
        this.callParent(arguments);
        this.setButtonsHidden(false, this.getButtonsSide(this.leftButtons && (this.leftButtonsShowMode == "focus" || this.leftButtonsShowMode == "mouseoverorfocus"), this.rightButtons && (this.rightButtonsShowMode == "focus" || this.rightButtonsShowMode == "mouseoverorfocus")));
    },
    postBlur: function() {
        this.callParent(arguments);
        this.setButtonsHidden(true, this.getButtonsSide(this.leftButtons && (this.leftButtonsShowMode == "focus" || (this.leftButtonsShowMode == "mouseoverorfocus" && !this.hasMouse)), this.rightButtons && (this.rightButtonsShowMode == "focus" || (this.rightButtonsShowMode == "mouseoverorfocus" && !this.hasMouse))));
    },
    onMouseOver: function() {
        this.hasMouse = true;
        this.setButtonsHidden(false, this.getButtonsSide(this.leftButtons && (this.leftButtonsShowMode == "mouseover" || this.leftButtonsShowMode == "mouseoverorfocus" || (this.leftButtonsShowMode == "mouseovernonblank" && this.getRawValue().length > 0)), this.rightButtons && (this.rightButtonsShowMode == "mouseover" || this.rightButtonsShowMode == "mouseoverorfocus" || (this.rightButtonsShowMode == "mouseovernonblank" && this.getRawValue().length > 0))));
    },
    onMouseOut: function() {
        this.hasMouse = false;
        this.setButtonsHidden(true, this.getButtonsSide(this.leftButtons && (this.leftButtonsShowMode == "mouseover" || (this.leftButtonsShowMode == "mouseoverorfocus" && !this.hasFocus) || this.leftButtonsShowMode == "mouseovernonblank"), this.rightButtons && (this.rightButtonsShowMode == "mouseover" || (this.rightButtonsShowMode == "mouseoverorfocus" && !this.hasFocus) || this.rightButtonsShowMode == "mouseovernonblank")));
    },
    onChange: function() {
        var nonEmpty;
        this.callParent(arguments);
...
Ext.form.trigger.Trigger.getIcon = function(icon) {
    ...
    if (iconName !== "combo" && iconName !== "clear" && iconName !== "date" && iconName !== "search") {
        ...
        if (!this.registeredIcons[key]) {
            ...
            if (Ext.net.ResourceMgr.theme == "neptune" || Ext.net.ResourceMgr.theme == "crisp" || Ext.net.ResourceMgr.theme == "neptunetouch" || Ext.net.ResourceMgr.theme == "crisptouch") {
...
Ext.define('Ext.form.trigger.Trigger.extnet', {
    ...
    removeBorderIfSimple: function(field) {
        var first, i, triggers, len, isSimple = false;
        field = field || this.field, triggers = field.orderedTriggers;
    ...
    renderTrigger: function(fieldData) {
        var me = this,
            ...
            triggers, len, isNotLast, isTouchTheme, forceSimple;
        ...
        if (forceSimple || Ext.net.StringUtils.startsWith(me.cls || "", "x-form-simple")) {
            ...
            if (triggers[0] == this) {
                if (this.field.inputWrap) {
                    this.field.inputWrap.setStyle({
                        "border-right-width": "0px"
                    });
                } else {
                    this.field.on("afterrender", function() {
                        this.inputWrap.setStyle({
                            "border-right-width": "0px"
                        });
                    }, this.field, {
                        single: true
    ...
    isCustomTrigger: function() {
        return !((this.handler == "onTriggerClick" || this.handler == this.field.onTriggerClick) && (this.scope == "this" || this.scope == this.field));
    },
...
Ext.form.field.ComboBox.override({
    ...
    getSubmitArray: function() {
        ...
        if (!this.valueCollection || this.valueCollection.getCount() === 0) {
            ...
            if (!Ext.isEmpty(value)) {
                ...
                if (!record) {
                    this.mon(this.store, "load", this.syncHiddenState, this, {
                        single: true
                    });
                    return [{
                        value: value
    ...
    initMerge: function() {
        if (this.mergeItems) {
            ...
            if (this.store.getCount() === 0 || this.alwaysMergeItems) {
                this.mon(this.store, "load", this.doMerge, this, {
    ...
    setInitValue: function(value) {
        ...
        if (this.store.getCount() > 0) {
            ...
            this.mon(this.store, "load", set, this, {
                single: true
            });
...
Ext.form.field.HtmlEditor.override({
    escapeValue: true,
    componentTpl: ['{beforeTextAreaTpl}', '<textarea id="{id}-textareaEl" data-ref="textareaEl" name="{name}" tabindex="-1" {inputAttrTpl}', ' class="{textareaCls}" autocomplete="off">', '{[escape(values.value)]}', '</textarea>', '{afterTextAreaTpl}', '{beforeIFrameTpl}', '<iframe id="{id}-iframeEl" data-ref="iframeEl" name="{iframeName}" frameBorder="0" {iframeAttrTpl}', ' src="{iframeSrc}" class="{iframeCls}"></iframe>', '{afterIFrameTpl}', {
        disableFormats: true
    }],
    initComponent: function() {
...
Ext.define("Ext.net.Label", {
    ...
    renderTpl: ['<tpl if="iconAlign == \'left\'">', '<img id="{id}-imgEl" data-ref="imgEl" src="{[Ext.BLANK_IMAGE_URL]}" class="' + Ext.baseCSSPrefix + 'label-icon', '<tpl if="!Ext.isEmpty(iconCls)"> {iconCls}</tpl>', '"/>', '</tpl>', '<span id="{id}-textEl" data-ref="textEl" class="' + Ext.baseCSSPrefix + 'label-value">', '<tpl if="!Ext.isEmpty(html)">{html}</tpl>', '</span>', '<tpl if="iconAlign == \'right\'">', '<img src="{[Ext.BLANK_IMAGE_URL]}" class="' + Ext.baseCSSPrefix + 'label-icon', '<tpl if="!Ext.isEmpty(iconCls)"> {iconCls}</tpl>', '"/>', '</tpl>', ],
...
Ext.define("Ext.net.Hyperlink", {
    ...
    beforeRender: function() {
        ...
        Ext.apply(me.childEls, {
            imgEl: {
                select: '.' + Ext.baseCSSPrefix + 'label-icon'
            },
            textEl: {
                select: 'a'
            }
...
Ext.define("Ext.net.Image", {
    ...
    renderTpl: ['<img src="{src}" style="border:none;"', '<tpl if="!Ext.isEmpty(altText)"> alt="{altText}"</tpl>', '<tpl if="!Ext.isEmpty(align)"> align="{align}"</tpl>', '<tpl if="!Ext.isEmpty(cls)"> class="{cls}"</tpl>', '<tpl if="!Ext.isEmpty(title)"> title="{title}"</tpl>', '/>', ],
    initComponent: function() {
...
Ext.data.proxy.Server.override({
    ...
    buildRequest: function(operation) {
        ...
        var me = this,
            ...
            request, operationId, idParam, method;
...
Ext.define("Ext.data.proxy.OData", {
    ...
    buildUrl: function(request) {
        ...
        if (request.getAction() == "read") {
            request.setParams(Ext.apply(params, {
...
Ext.data.writer.Writer.override({
    ...
    write: function(request) {
        var operation = request.getOperation(),
            record, records = operation.getRecords() || [],
            len = records.length,
            i = 0,
            data = [];
        for (; i < len; i++) {
    ...
    getRecordData: function(record, operation) {
        ...
        if ((this.excludeId && ret.hasOwnProperty(idField.name)) || (this.skipIdForPhantomRecords !== false && ret.hasOwnProperty(idField.name) && phantom)) {
...
Ext.data.AbstractStore.override({
    ...
    createTempProxy: function(callback, proxyConfig, sync) {
        ...
        this.proxy.on("endprocessresponse", function(proxy, response, operation) {
            this.proxy.destroy();
    ...
    prepareRecord: function(data, record, options, isNew) {
        var newData = {},
            field, idProp = record.self.idField.name,
            idMap = record.self.idField.mapping,
            m, mappings, map = record.getFieldsMap();
...
Ext.data.ProxyStore.override({
    ...
    getRecordsValues: function(options) {
        ...
        for (i = 0; i < records.length; i++) {
            var obj = {},
                dataR, idProp = records[i].self.idField.name;
        ...
        reload: function(options) {
            ...
            if (treeStore) {
                ...
                if (treeStore.getClearOnLoad()) {
                    treeStore.unregisterNode(this, true);
                }
...
Ext.toolbar.Paging.override({
    initComponent: function() {
        ...
        this.onLoad = Ext.Function.createBuffered(this.onLoad, 50);
        this.callParent(arguments);
        if (this.hideRefresh) {
...
Ext.grid.Panel.override({
    ...
    getRowsValues: function(config) {
        ...
        var records = (config.selectedOnly ? this.selModel.getSelection() : config.currentPageOnly ? this.store.getRange() : this.store.getAllRange()) || [],
            values = [],
            record, sIds, i, idProp = this.store.getModel().idField.name;
...
Ext.define("Ext.net.GridPrinter", {
    ...
    statics: {
            ...
            Ext.each(this.get("currentPageOnly", config) ? grid.store.getRange() : grid.store.getAllRange(), function(record, index) {
                ...
                for (i = 0, len = columns.length; i < len; i++) {
                    ...
                    if (c.dataIndex) {
                        ...
                        item[Ext.String.createVarName(c.id)] = c.renderer.call(c, null, meta, record, index, i, grid.store, grid.view);
        ...
        getBody: function(grid, columns, data, rowBody) {
            var groups, fields = grid.store.getModel().getFields(),
            ...
            if (grid.store.isGrouped()) {
                ...
                var bodyTpl = ['<tpl for=".">', '<tr class="group-header">', '<td colspan="{[this.colSpan]}">', (feature.groupHeaderTpl.html || ''), '</td>', '</tr>', '<tpl for="items">', '<tr class="{[xindex % 2 === 0 ? "even" : "odd"]}">', '<tpl for="this.columns">', '<td>', '{[ this.getValue(parent, Ext.String.createVarName(values.dataIndex || values.id)) ]}', '</td>', '</tpl>', '</tr>', '<tr class="{[xindex % 2 === 0 ? "even" : "odd"]}">', (rowBody || ""), '</tr>', '</tpl>', '</tpl>', {
                    getBodyContent: this.getBodyContent,
                    view: grid.view,
                    columns: columns,
                    fields: fields,
...
Ext.grid.feature.Grouping.override({
    getSummary: Ext.grid.feature.AbstractSummary.prototype.getSummary
});
Ext.grid.feature.Summary.prototype.fullSummaryTpl[Ext.grid.feature.Summary.prototype.fullSummaryTpl.length - 1].beginRowSync = function(rowSync) {
    rowSync.add('fullSummary', this.owner.summaryRowSelector);
};
...
Ext.grid.plugin.CellEditing.override({
    getColumnField: function(columnHeader, defaultField, record) {
        if (columnHeader instanceof Ext.grid.column.Check || columnHeader instanceof Ext.grid.column.Action || columnHeader instanceof Ext.grid.RowNumberer) {
            return;
        }
...
Ext.define('Ext.net.RowExpander', {
    ...
    toggleRow: function(rowIdx, record, state) {
        ...
        var me = this,
            ...
            lockedRow, nextBd = normalRow.down(this.rowBodyTrSelector),
            ...
            grid = this.grid,
            rowCmp, needContainer, rowSpan = wasCollapsed ? 2 : 1,
...
Ext.define('Ext.grid.plugin.SelectionSubmit', {
    ...
    getSelectionModelField: function() {
        if (!this.hField) {
            ...
            this.hField = new Ext.form.field.Hidden({
                name: id
            });
        }
        return this.hField;
    ...
    cellCommandRenderer: function(value, meta, record, row, col, store, view) {
        ...
        if (me.commands && me.commands.length > 0 && me.isCellCommand) {
            ...
            if (typeof me.userRenderer === "function") {
                userRendererValue = me.userRenderer.call(me.rendererScope || me, value, meta, record, row, col, store, view);
            }
        ...
        if (typeof me.userRenderer === "function") {
            value = me.userRenderer.call(me.rendererScope || me.ownerCt, value, meta, record, row, col, store, view);
        }
        return value;
    },
...
Ext.define("Ext.grid.column.ComponentColumn", {
    ...
    initRenderData: function() {
        ...
        if (me.overOnly) {
            ...
            me.view.on("refresh", me.mayShowPin, me, {
                buffer: 10
            });
...
Ext.view.View.override({
    ...
    handleEvent: function(e) {
        var me = this,
            item = e.getTarget();
        if (me.isDestroyed || ((Ext.fly(item).parent("." + me.baseCls) == me.el) && (!me.body || me.body.contains(item)))) {
            return this.callParent(arguments);
        }
    },
...
Ext.tree.Panel.override({
    ...
    excludeAttributes: ["parentId", "index", "leaf", "depth", "expanded", "expandable", "cls", "icon", "iconCls", "root", "isLast", "isFirst", "allowDrag", "allowDrop", "loaded", "loading", "href", "hrefTarget", "qtip", "qtitle", "qshowDelay", "children", "dataPath", "selected", "visible"],
...
Ext.define('Ext.net.InfoPanel', {
    ...
    toFront: function() {
        this.setZIndex(this.zIndexManager.zseed);
        if (this.modal) {
            this.zIndexManager.showModalMask(this);
        }
    },
    initComponent: function() {
        var noqueue = false;
...
Ext.layout.container.Column.override({
    ...
    calculateItems: function(ownerContext, containerSize) {
        var me = this,
            ...
            len = items.length,
            i, itemContext, ownerHeight = ownerContext.target.getHeight() - ownerContext.targetContext.getPaddingInfo().height;
        for (i = 0; i < len; ++i) {
            itemContext = items[i];
...
Ext.override(Ext.picker.Color, {
    getColorField: function() {
        if (!this.colorField) {
            this.colorField = new Ext.form.field.Hidden({
                name: this.id
            });
            this.on("beforedestroy", function() {
                this.destroy();
...
Ext.picker.Date.override({
    initComponent: function() {
        this.callParent(arguments);
        this.on("render", this.onDateSelect, this, {
            single: true
        });
...
Ext.picker.Time.override({
    initComponent: function() {
        ...
        this.on("render", this.onTimeSelect, this, {
            single: true
        });
    },
...
Ext.toolbar.Breadcrumb.override({
    ...
    updateSelection: function(node) {
        var me = this,
            ...
            showIcons, glyph, iconCls, icon, newItemCount, currentNode, text, button, id, depth, i, tooltip;
        Ext.suspendLayouts();
        if (node) {
            currentNode = node;
...
(function() {
    ...
    if (Ext.isChrome) {
        buf.push(".x-form-text { display: inherit; }");
    }
