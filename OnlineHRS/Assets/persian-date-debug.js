...
/***/ (function (module, exports, __webpack_require__) {
                ...
                var PersianDateClass = function () {
                    ...
                    function PersianDateClass(input) {
                        ...
                        var dateFar = this.format('L');
                        var dateEng = farsiToEnglish(dateFar);
                        this.dayDate = dateEng;
                        this.intDate = dateToNumber(dateEng);
                        this.farsiDate = dateFar

                        //this.dayDateEng = farsiToEnglish(this.format('L'))
                        return this;
                    }
